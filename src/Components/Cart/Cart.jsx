...
export default function Cart() {
  ...
  return (
    <>
      {!cart ? (
        <h1 className="text-4xl text-center pt-52 h-screen font-semibold text-emerald-700">
          Cart Is Empty
        </h1>
      ) : (
        <div>
              ...
              <div className="container flex justify-between items-center">
                <div className="container space-x-32 flex items-center">
                  ...
                  <div>
                    <Link
                      to={"/checkout"}
                      className="bg-emerald-600 text-white p-2 m-2 rounded hover:bg-emerald-700 transition-all"
                    >
                      Checkout
                    </Link>
                  </div>
